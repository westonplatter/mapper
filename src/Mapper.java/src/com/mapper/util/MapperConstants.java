...
public class MapperConstants
{
    ...
    public static final int SAVE_TO_FAVORITES_SELECTION = 300;
    
    public static final double SKYWAY_MAP_CENTER_LATITUDE  = 44.975667;
    public static final double SKYWAY_MAP_CENTER_LONGITUDE = -93.270793;
